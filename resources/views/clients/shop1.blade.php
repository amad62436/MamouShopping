...
@section('content')
    ...
    <section class="welcome_area">
        <div class="welcome_slides owl-carousel">
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(clients/img/bg-img/8.jpg);">
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-5 col-md-4">
                            <div class="welcome_slide_image">
                                <img src="clients/img/bg-img/slide-1.png" alt="" data-animation="bounceInUp" data-delay="500ms">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(clients/img/bg-img/7.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
            ...
            <!-- Single Slide -->
            <div class="single_slide bg-img" style="background-image: url(clients/img/bg-img/6.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                    ...
                    <div class="new_arrivals_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-1-back.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-1.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-6.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-6-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-2.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-2-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-4.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-4-back.png" alt="">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-5.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-5-back.png" alt="">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured_offer_area d-flex align-items-center" style="background-image: url(clients/img/bg-img/fea_offer.jpg);">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="featured_product_slides owl-carousel">
                        ...
                        <div class="single-product-area">
                            <div class="product_image">
                                <!-- Product Image -->
                                <img class="normal_img" src="clients/img/product-img/new-7.png" alt="">
                                <img class="hover_img" src="clients/img/product-img/new-7-back.png" alt="">
                                ...
                                <div class="top_sellers_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-1.png" alt="Top-Sellers">
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Beach Cap</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Gold Neckless</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Shoes</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/top-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Pin Up Bikini</h5>
                                ...
                                <div class="best_rated_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-1.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sports Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Women Watch</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Headphone</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Plus Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/best-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Laptop</h5>
                                ...
                                <div class="on_sale_area">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-1.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Speaker</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-2.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Fancy Lamp</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-3.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Sport Bra</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-4.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>S'well Water</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-5.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>Slipper</h5>
                                        ...
                                        <div class="col-12 col-sm-6 col-lg-4">
                                            <div class="single_top_sellers">
                                                <div class="top_seller_image">
                                                    <img src="clients/img/product-img/onsale-6.png" alt="Top-Sellers">
                                                </div>
                                                <div class="top_seller_desc">
                                                    <h5>T-shirt</h5>
